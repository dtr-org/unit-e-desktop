...
import { RpcStateService, IpcService } from '../../core/core.module';
...
export class CreateWalletComponent implements OnDestroy {
  ...
  reset(): void {
    ...
    this.errorString = '';
    this.step = 0;
    this.rpcState.observe('getwalletinfo', 'unlocked_until')
      .takeWhile(() => !this.destroyed)
      .subscribe(unlocked => this.isCrypted = (unlocked !== undefined));
  }
